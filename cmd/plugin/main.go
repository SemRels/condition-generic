...
import (
	...
	grpcserver "github.com/SemRels/condition-generic/internal/grpc"
	semrelplugin "github.com/SemRels/condition-generic/internal/plugin"
)

func main() {
	provider := semrelplugin.NewProvider("condition-generic")
